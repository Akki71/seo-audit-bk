...
if (accessToken) {
  ...
  // ------------------------------------
  // 4️⃣ FINAL RESPONSE (SEMRUSH-LIKE)
  // ------------------------------------
  return {
    seoAuthority: {
      organicTraffic: totalClicks,
      ...
      avgPosition: +avgPosition.toFixed(2),
      organicKeywords: rows.length,
      domainAuthority: moz.domain_authority || 0,
      pageAuthority: moz.page_authority || 0,
      spamScore: moz.spam_score || 0
    },

    seo_links: {
      referringDomains: moz.root_domains_to_root_domain || 0,
      backlinks: moz.external_pages_to_root_domain || 0,
      totalBacklinks: moz.pages_to_root_domain || 0,
      backlinkTypes: {
        dofollow:
          (moz.external_pages_to_root_domain || 0) -
          (moz.external_nofollow_pages_to_root_domain || 0),
        nofollow: moz.external_nofollow_pages_to_root_domain || 0,
        redirect: moz.external_redirect_pages_to_root_domain || 0
      }
    },
    opportunities: {
      lowCTRKeywords: lowCTRKeywords.length,
